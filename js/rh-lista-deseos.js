// MW JOYERÍA — Lista de deseos RH
//
// Mismo comportamiento que Staff: ver todas las solicitudes de las
...
// (mw-staff-deseos-v1), sin lista independiente para RH.
//
// Única diferencia respecto a Staff: avanzar el estado NO pide
// usuario/contraseña de nuevo — muestra el modal de Autorización de
// RH con mensaje dinámico (ver js/rh-comun.js) y queda en la
// auditoría de RH. Ver detalle es informativo, no requiere
// autorización (sección 17).
...
function avanzarDeseo(id, nuevoEstado) {
  ...
  deseo.ultimaAccion = {
    ...
    usuario: RH_IDENTIDAD.usuarioNombre,
  ...
  registrarAuditoriaRH({ modulo: 'lista_deseos', accion: 'avanzar_estado', descripcion: `Solicitud "${deseo.titulo}" de ${deseo.emprendedora} → ${textos[nuevoEstado] || nuevoEstado}` });
  mostrarToast(`Solicitud actualizada por ${RH_IDENTIDAD.usuarioNombre}.`);
