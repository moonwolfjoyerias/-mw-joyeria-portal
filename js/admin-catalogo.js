...
function guardarStock(id, nuevosValores) {
  ...
  registrarAuditoriaAdmin({ modulo: 'catalogo', accion: 'modificar_existencia', descripcion: `Existencia de "${producto.nombre}" cambiada a ${stockTotalProducto(producto)} piezas` });
